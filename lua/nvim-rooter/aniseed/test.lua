local _0_0 = nil
do
  local name_0_ = "nvim-rooter.aniseed.test"
...
local function _2_(...)
  ...
  local function _2_()
    return {require("nvim-rooter.aniseed.core"), require("nvim-rooter.aniseed.nvim"), require("nvim-rooter.aniseed.string")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "nvim-rooter.aniseed.core", nvim = "nvim-rooter.aniseed.nvim", str = "nvim-rooter.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-rooter.aniseed.test"
