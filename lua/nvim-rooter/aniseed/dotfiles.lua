local _0_0 = nil
do
  local name_0_ = "nvim-rooter.aniseed.dotfiles"
...
local function _2_(...)
  ...
  local function _2_()
    return {require("nvim-rooter.aniseed.compile"), require("nvim-rooter.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {compile = "nvim-rooter.aniseed.compile", nvim = "nvim-rooter.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-rooter.aniseed.dotfiles"
