local _0_0 = nil
do
  local name_0_ = "nvim-rooter.aniseed.compile"
...
local function _2_(...)
  ...
  local function _2_()
    return {require("nvim-rooter.aniseed.core"), require("nvim-rooter.aniseed.fennel"), require("nvim-rooter.aniseed.fs"), require("nvim-rooter.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "nvim-rooter.aniseed.core", fennel = "nvim-rooter.aniseed.fennel", fs = "nvim-rooter.aniseed.fs", nvim = "nvim-rooter.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-rooter.aniseed.compile"
...
do
  ...
  do
    ...
    local function macros_prefix0(code)
      local macros_module = "nvim-rooter.aniseed.macros"
